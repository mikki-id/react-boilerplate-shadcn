...
### Create React Project with Vite (javascript)

Source: https://ui.shadcn.com/docs/installation/vite

Command to create a new React project using Vite with the javascript template. This is the initial step for setting up the project.
...
### Create a Simple Component (javascript/React)

Source: https://ui.shadcn.com/docs/registry/getting-started

An example of a basic component file, `hello-world.js`, intended to be part of a registry. This component uses a Button from `@/components/ui/button`. It should be placed within a structured directory like `registry/[NAME]/[COMPONENT_NAME]/`.
...
This example shows how to define a 'login-01' block, specifying its type, description, dependencies, and the files it comprises. The 'page.js' and 'login-form.js' are included as part of the block.
...
Installs the 'sidebar.js' component using the pnpm package manager. This is the recommended method for adding the component to your project.
