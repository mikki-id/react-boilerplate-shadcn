...
```bash
# New Next.js project
npx create-next-app@latest my-app --javascript --tailwind --eslint --app
cd my-app
...
```tsx
// 1. Add <Toaster /> to app/layout.js
...
- **Type Safety**: Use javascript and Zod schemas for form validation
