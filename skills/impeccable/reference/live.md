...
`RELATIVE_PATH` is relative to project root (`public/index.html`, `src/App.js`, etc.); the browser fetches source directly if the dev server lacks HMR.
...
| Next.js (App Router) | `["app/layout.js"]` | `</body>` | `jsx` |
| Next.js (Pages) | `["pages/_document.js"]` | `</body>` | `jsx` |
...
Reference outputs:
- `tests/framework-fixtures/nextjs-turborepo/expected-after-patch.js` (Next.js)
...
- `tests/framework-fixtures/nuxt-csp/expected-after-patch.js` (Nuxt)
